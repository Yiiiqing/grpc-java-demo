...
public final class AddServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<zone.yiqing.grpc.AddRequest,
      zone.yiqing.grpc.AddReply> getAddMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "add",
      requestType = zone.yiqing.grpc.AddRequest.class,
      responseType = zone.yiqing.grpc.AddReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<zone.yiqing.grpc.AddRequest,
      zone.yiqing.grpc.AddReply> getAddMethod() {
    io.grpc.MethodDescriptor<zone.yiqing.grpc.AddRequest, zone.yiqing.grpc.AddReply> getAddMethod;
      ...
      synchronized (AddServiceGrpc.class) {
        if ((getAddMethod = AddServiceGrpc.getAddMethod) == null) {
          AddServiceGrpc.getAddMethod = getAddMethod =
              io.grpc.MethodDescriptor.<zone.yiqing.grpc.AddRequest, zone.yiqing.grpc.AddReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "add"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  zone.yiqing.grpc.AddRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  zone.yiqing.grpc.AddReply.getDefaultInstance()))
  ...
  public static final class AddServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<AddServiceBlockingStub> {
    ...
    /**
     */
    public zone.yiqing.grpc.AddReply add(zone.yiqing.grpc.AddRequest request) {
  ...
  public static final class AddServiceFutureStub extends io.grpc.stub.AbstractFutureStub<AddServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<zone.yiqing.grpc.AddReply> add(
        zone.yiqing.grpc.AddRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_ADD:
          serviceImpl.add((zone.yiqing.grpc.AddRequest) request,
              (io.grpc.stub.StreamObserver<zone.yiqing.grpc.AddReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class AddServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return zone.yiqing.grpc.AddServiceProto.getDescriptor();
    }
